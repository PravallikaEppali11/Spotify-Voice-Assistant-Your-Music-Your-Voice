...
function speakThis(message) {
    ...
    else if(message.includes('open sleepy songs')) {
    ...
    else if(message.includes('open hindi songs')) {
        window.open("https://open.spotify.com/playlist/6oE7P6Q0vYsX2xIPMTDfqP", "play");
        const finalText = "Opening hindi songs";
        speech.text = finalText;
    }

    else if(message.includes('open trending songs')) {
        window.open("https://open.spotify.com/genre/0JQ5DAqbMKFQIL0AXnG5AK", "play");
        const finalText = "Opening trending songs";
        speech.text = finalText;
    }
    ...
    else if(message.includes('open punjabi songs')) {
        window.open("https://open.spotify.com/playlist/5d4c8BsbClVkrNX92F5Zau", "play");
        const finalText = "Opening punjabi songs";
        speech.text = finalText;
    }
    ...
    else if(message.includes('open party songs')) {
        window.open("https://open.spotify.com/genre/0JQ5DAqbMKFA6SOHvT3gck", "play");
        const finalText = "Opening party songs";
        speech.text = finalText;
    }

    else if(message.includes('open cooking songs')) {
        window.open("https://open.spotify.com/playlist/0NGgMUwprsrL1ScFCwquxf", "play");
        const finalText = "Opening cooking songs";
        speech.text = finalText;
    }

    else if(message.includes('open cooking songs')) {
        window.open("https://open.spotify.com/genre/0JQ5DAqbMKFAXlCG6QvYQ4", "play");
        const finalText = "Opening workout songs";
        speech.text = finalText;
    }

    else if(message.includes('open k-pop songs')) {
        window.open("https://open.spotify.com/genre/0JQ5DAqbMKFGvOw3O4nLAf", "play");
        const finalText = "Opening k-pop songs";
        speech.text = finalText;
    }

    else if(message.includes('open english songs')) {
        window.open("https://open.spotify.com/playlist/1gmnT7keFVDxP47kHEZdYC", "play");
        const finalText = "Opening english songs";
        speech.text = finalText;
    }

    else if(message.includes('open relaxing music')) {
        window.open("https://open.spotify.com/artist/79fCdYLGgNbdxzAAlOhShc", "play");
        const finalText = "Opening relaxing music";
        speech.text = finalText;
    }

    else if(message.includes('open happy song')) {
        window.open("https://open.spotify.com/playlist/4nd7oGDNgfM0rv28CQw9WQ", "play");
        const finalText = "Opening happy song";
        speech.text = finalText;
    }

    else if(message.includes('open bhajana songs')) {
        window.open("https://open.spotify.com/playlist/4HJUL6Wgo6HriTh3ZFsTmH", "play");
        const finalText = "Opening bhajana songs";
        speech.text = finalText;
    }
